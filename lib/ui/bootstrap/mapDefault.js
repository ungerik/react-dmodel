...
const mapping = {
	...
	Float: (element, getValue, setValue, extraProps, parents, refCallback, key) => {
		...
		if (props.style.slider) {
			return <Slider {...{...props.style.slider, ...props, ...extraProps}} ref={refCallback} key={key} label={getLabel(props)} fixed={setValue === null} value={getValue(props.name)} onChange={value => setValue(props.name, value)} />;
		}
		return <FloatInput {...{...props, ...extraProps}} ref={refCallback} key={key} label={getLabel(props)} disabled={setValue === null} placeholder={props.style.placeholder} addonAfter={props.unit} value={getValue(props.name)} onChange={value => setValue(props.name, value)} />;
	},
	...
	Int: (element, getValue, setValue, extraProps, parents, refCallback, key) => {
		...
		if (props.style.slider) {
			return <Slider {...{...props.style.slider, ...props, ...extraProps}} ref={refCallback} key={key} label={getLabel(props)} fixed={setValue === null} integer value={getValue(props.name)} onChange={value => setValue(props.name, value)} />;
		}
		return <IntInput {...{...props, ...extraProps}} ref={refCallback} key={key} label={getLabel(props)} disabled={setValue === null} placeholder={props.style.placeholder} addonAfter={props.unit} value={getValue(props.name)} onChange={value => setValue(props.name, value)} />;
	},
	...
	Uint: (element, getValue, setValue, extraProps, parents, refCallback, key) => {
		...
		return <UintInput {...{...props, ...extraProps}} ref={refCallback} key={key} label={getLabel(props)} disabled={setValue === null} placeholder={props.style.placeholder} addonAfter={props.unit} value={getValue(props.name)} onChange={value => setValue(props.name, value)} />;
	},
	...
	Text: (element, getValue, setValue, extraProps, parents, refCallback, key) => {
		...
		return <TextInput {...{...props, ...extraProps}} ref={refCallback} key={key} label={getLabel(props)} disabled={setValue === null} placeholder={props.style.placeholder} value={getValue(props.name)} onChange={value => setValue(props.name, value)} />;
	},
